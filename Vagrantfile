...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "pasupulaphani-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/phanindercom"
  #   chef.validation_client_name = "phanindercom-validator"
  #   chef.validation_key_path = ".chef/phanindercom-validator.pem"
  # end
end
